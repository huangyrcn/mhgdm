...
import torch
import numpy as np
from utils.manifolds_utils import transp0back_after_logmap, exp_after_transp0, mobius_scalar_mul


class SDE(abc.ABC):
    """SDE abstract class. Functions are designed for a mini-batch of inputs."""

    def __init__(self, N, manifold=None):
        """Construct an SDE.
...
class VPSDE(SDE):
    def __init__(self, beta_min=0.1, beta_max=20, N=1000, manifold=None):
...
class VESDE(SDE):
    def __init__(self, sigma_min=0.01, sigma_max=50, N=1000, manifold=None):
